            ...
            <Stack spacing={1}>
                ...
                <Stack direction="row" flexWrap="wrap" gap={0.5}>
                  {task.labels.map(l => (
                    <Chip
                      ...
                      label={l}
                      size="small"
                      sx={{ height: 18, fontSize: 10, fontWeight: 600, bgcolor: labelColor(l), color: '#fff' }}
                    />
                  ))}
                </Stack>
              )}
              ...
              {due && (
                <Stack direction="row" alignItems="center" spacing={0.5}>
                  <CalendarTodayIcon sx={{ fontSize: 12, color: isOverdue ? '#ef4444' : isDueToday ? '#f59e0b' : '#94a3b8' }} />
                  <Typography
                    variant="caption"
